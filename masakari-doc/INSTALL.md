...
| enabled     | True                             |
| id          | e5fa38134c4741e99862404f894e0918 |
| name        | masakari                         |
| type        | instance-ha                      |
+-------------+----------------------------------+
```
...
+--------------+------------------------------------------+
| enabled      | True                                     |
| id           | 871e77c1afae41ef873cb3e719588cd7         |
| interface    | public                                   |
| region       | RegionOne                                |
| region_id    | RegionOne                                |
| service_id   | e5fa38134c4741e99862404f894e0918         |
...
+--------------+------------------------------------------+
| enabled      | True                                     |
| id           | 5b32681f67164b39b9a960e2633f47ea         |
| interface    | internal                                 |
| region       | RegionOne                                |
| region_id    | RegionOne                                |
| service_id   | e5fa38134c4741e99862404f894e0918         |
...
+--------------+------------------------------------------+
| enabled      | True                                     |
| id           | bd36c9ac1dae4c5290db3cdaf1c0f57d         |
| interface    | admin                                    |
| region       | RegionOne                                |
| region_id    | RegionOne                                |
| service_id   | e5fa38134c4741e99862404f894e0918         |
